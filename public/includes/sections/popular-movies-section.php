        ...
        <div class="row-custom container-popular-details-trailer">
            <div class="current-trending-movie-details">
                <div class="movie-card-info-container">
                    ...
                    <a class="current-trending-button" href=""> <button class="button-custom current-trending-button">Book</button></a>
                ...
                <div class="trailers-selected-movies ">
                    ...
                    <div class="trailer-trending-selected-movie-card">
                        <iframe class="selected-popular-movie-trailer"width="100%" height="100%" src="https://www.youtube.com/embed/hR1-ihzff3I?si=DvPZEjflRhqxEveA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
