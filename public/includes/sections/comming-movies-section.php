<section class="trending-section section-commingsoon">
        ...
        <img class="arrow-section comming-arrow slider-arrow-comming-right"src="./imgs/icons/right-arrow.svg" alt="">
        ...
        <div class="wrapper-content">
            ...
            <div class="row-custom header-section-container">
                <h5 class="section-header white-text  text-mid header-intersect3">Comming soon</h5>
            ...
            <div class="movies-container expandable-container">
                <div class="scrolling-wrapper comming-slider row-custom">
                    <?php
                        get_kinds_movies_cards("comming_soon", "movie_big_card")
