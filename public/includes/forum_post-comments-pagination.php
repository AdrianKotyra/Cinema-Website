<?php 
    ...
    $start = ($page - 1) * $limit;
    // Retrieve the data
    $sql = "SELECT * FROM comments_forum where comment_post_id = $post_id LIMIT $start, $limit";
...
<div class="pagination-container">
    <ul class="row-custom">
        <?php if($page > 1): ?>
            <li><a href="?id=<?php echo $post_id; ?>&page=<?php echo $page-1; ?>">Previous</a></li>
        <?php endif; ?>

        <?php for($i = 1; $i <= $total_pages; $i++): ?>
            <li style="margin: 0 5px;">
            <a class="<?php if($i == $page) echo 'active-page'; ?>" 
            href="?id=<?php echo $post_id; ?>&page=<?php echo $i; ?>">
            <?php echo $i; ?>
            </a>
        ...
        <?php if($page < $total_pages): ?>
            <li><a href="?id=<?php echo $post_id; ?>&page=<?php echo $page+1; ?>">Next</a></li>
        <?php endif; ?>
    </ul>
</div>