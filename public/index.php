...
<body>
  ...
  <?php include("./includes/sections/current-movies-section.php")  ?>
  <?php include("./includes/sections/more-movies-section.php")  ?>
  <?php include("./includes/sections/categories-movies-section.php")  ?>
