...
include "../php/init.php";
    ...
    if( $session->signed_in==true) {
        ...
        $query1 = "SELECT * FROM news_comments_likes where news_comment_id = $forumCommentId AND user_liker_id =  $user_id";
        $check_user_likes_query = mysqli_query($connection, $query1);
        $user_num_likes = mysqli_num_rows($check_user_likes_query);
        if($user_num_likes>=1) {
           
            $query3 = "DELETE FROM news_comments_likes WHERE news_comment_id = $forumCommentId AND user_liker_id =  $user_id";
           ...
           $number_likes = check_num_likes_query($forumCommentId);
            ...
            $query2 = "INSERT INTO news_comments_likes( news_comment_id, user_liker_id, news_comment_post_id) ";
