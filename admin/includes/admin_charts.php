<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading  movies-panel">
                <div class="row">
                    <div class="col-xs-3">
                        <i class="fa fa-list fa-5x"></i>
                    </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="faq.php">
                <div class="panel-footer">
                    <span class="pull-left">FAQ Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            <div class="panel-heading reviews-panel">
                <div class="row">
                    <div class="col-xs-3">
                        <i class="fa fa-list fa-5x"></i>
                    </div>
            ...
            <a href="reviews.php">
                <div class="panel-footer">
                    <span class="pull-left">Review Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="forum.php">
                <div class="panel-footer">
                    <span class="pull-left">Forum posts details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="staff.php">
                <div class="panel-footer">
                    <span class="pull-left">Staff Members details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="tickets.php">
                <div class="panel-footer">
                    <span class="pull-left">Tickets details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="comments.php">
                <div class="panel-footer">
                    <span class="pull-left">Comments news details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="admin_messages.php">
                <div class="panel-footer">
                    <span class="pull-left">admin messages details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
